/**
 * This file declares action generators in our application.
 * Actions are payloads of information with a specific purpose,
 *      that send data from our application to our store.
 *      Actions are send (dispatched) to the reducer to modify app state.
...
/**
 * action generator for reset password request
 * @param {Token} token - Token generated by server to reset password
